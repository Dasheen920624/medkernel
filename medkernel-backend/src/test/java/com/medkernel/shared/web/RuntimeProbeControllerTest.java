 ...
 *   <li>签发合法的 JWT Bearer Token（携带 ROLE_PLATFORM_ADMIN）请求，能够顺利穿透安全切面并获取虚拟线程快照。</li>
 * </ul>
 */
...
class RuntimeProbeControllerTest {
    ...
    /**
     * 验证在携带合法 ROLE_PLATFORM_ADMIN JWT Bearer 凭证的情况下，能通过探针审计，并获得虚拟线程真实指标。
     */
    @Test
    @SuppressWarnings("unchecked")
    void runtimeReportsJdk21AndVirtualThreadWithAuth() throws Exception {
        String token = generateToken("platform-admin");
