...
INSERT INTO sys_role (tenant_id, role_code, display_name, description, built_in_flag, active_flag, created_by, updated_by) VALUES ('SYSTEM', 'med-technician', '医技技师', '检验、影像、超声、心电、病理等医技科室技师：上报检查检验结果、维护本科室术语对照', 'Y', 'Y', 'migration-v6', 'migration-v6');
INSERT INTO sys_role (tenant_id, role_code, display_name, description, built_in_flag, active_flag, created_by, updated_by) VALUES ('SYSTEM', 'pharmacist', '临床药师', '用药规则评审起草、药学知识会签、用药提醒覆盖复核', 'Y', 'Y', 'migration-v6', 'migration-v6');
