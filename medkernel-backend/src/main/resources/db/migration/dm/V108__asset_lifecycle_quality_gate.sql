-- MedKernel v1.0 GA · 统一资产生命周期与发布质量门（达梦）
...
ALTER TABLE mk_version_release_plan ADD electronic_signature_id VARCHAR2(128) NULL;
ALTER TABLE mk_version_release_plan ADD electronic_signature_subject VARCHAR2(256) NULL;
ALTER TABLE mk_version_release_plan ADD electronic_signature_hash VARCHAR2(64) NULL;
ALTER TABLE mk_version_release_plan ADD electronic_signature_signed_at TIMESTAMP NULL;
ALTER TABLE mk_version_release_plan ADD quality_gate_summary VARCHAR2(2048) NULL;
