...
ALTER TABLE mk_version_inheritance_override ADD CONSTRAINT ck_mk_version_inheritance_override_lifecycle CHECK (lifecycle_status IN('DRAFT', 'IN_REVIEW', 'APPROVED', 'PUBLISHED', 'DEPRECATED', 'RETIRED'));
...
COMMENT ON COLUMN audit_event.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN canonical_resource.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN clinical_clock.trace_id IS '链路追踪标识';
COMMENT ON TABLE clinical_runtime_release IS '医院临床运行修订账本：只追加修订，锁定平台基线和完整物化资产清单摘要';
COMMENT ON COLUMN clinical_runtime_release.id IS '数据库主键';
COMMENT ON COLUMN clinical_runtime_release.release_id IS '不可变运行发布 ID';
COMMENT ON COLUMN clinical_runtime_release.tenant_id IS '医院所属租户';
COMMENT ON COLUMN clinical_runtime_release.hospital_id IS '运行发布适用医院';
COMMENT ON COLUMN clinical_runtime_release.revision_no IS '医院内自动递增运行修订号';
COMMENT ON COLUMN clinical_runtime_release.platform_baseline_release_id IS '采用的平台权威基线发布标识';
COMMENT ON COLUMN clinical_runtime_release.manifest_sha256 IS '完整物化资产清单 SHA-256 摘要';
COMMENT ON COLUMN clinical_runtime_release.rollback_from_release_id IS '回滚时复制的历史运行发布 ID';
...
COMMENT ON COLUMN clinical_event.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN clinical_event.runtime_release_id IS '医院临床运行发布 ID';
...
COMMENT ON COLUMN clinical_event_outbox.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN context_snapshot.runtime_release_id IS '医院临床运行发布 ID';
...
COMMENT ON COLUMN context_snapshot.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN embed_launch_token.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN evaluation_idempotency_key.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN evaluation_indicator.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN evaluation_result.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN evaluation_run.runtime_release_id IS '本次评估事实锁定的医院运行修订；无患者上下文的人工抽检可为空';
...
COMMENT ON COLUMN evaluation_run.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN followup_event.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN followup_plan.runtime_release_id IS '随访计划生成时锁定的医院运行修订 ID；使用随访模板时必填';
...
COMMENT ON COLUMN followup_plan.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN followup_questionnaire.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN followup_task.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN integration_message_log.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_care_plan.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_claim.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_condition.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_diagnostic_report.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_document.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_encounter.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_follow_up.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_medication.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_nursing_assessment.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_observation.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_patient.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_clinical_procedure.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_compliance_identity_binding.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_compliance_interop_assessment_item.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_context_field_catalog.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_diagnosis_care_pointer.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_diagnosis_confidence_policy.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_diagnosis_criterion.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_diagnosis_differential.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_diagnosis_test_case.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_emr_level_item.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_emr_level_target.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_engine_cdss_risk_matrix.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_engine_data_encrypted_field.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_engine_data_field_policy.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_experience_export_task.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_followup_template.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_identity_person.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_identity_person_account.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_identity_person_appointment.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_identity_person_import_job.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_integration_master_data_sync_batch.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_knowledge_customization.platform_version_id IS '派生时记录的平台基线版本主键';
...
COMMENT ON COLUMN mk_knowledge_customization.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_knowledge_diff.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_knowledge_expiry_task.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_knowledge_production_job.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_llm_eval_run.release_fingerprint IS '生成医学评测时冻结的运行制品指纹，必须与当前部署一致方可作为放行证据';
...
COMMENT ON COLUMN mk_plugin_grant.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_plugin_registry.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_projection_snapshot.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_projection_sync.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_quality_case_review.runtime_release_id IS '病案上下文快照锁定的医院运行修订';
...
COMMENT ON COLUMN mk_quality_case_review.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_quality_drg_grouping.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_sandbox_replay_asset_binding.trace_id IS '链路追踪标识';
COMMENT ON TABLE mk_sandbox_replay_case IS '沙盘历史重放不可变清单：保存 D4 脱敏上下文、来源运行修订引用和精确资产清单摘要';
...
COMMENT ON COLUMN mk_sandbox_replay_case.source_runtime_release_ref IS '来源医院运行修订的 SHA-256 不可逆引用，禁止保存可反查现场的真实标识';
COMMENT ON COLUMN mk_sandbox_replay_case.source_runtime_revision_no IS '来源医院当时使用的运行修订号';
...
COMMENT ON COLUMN mk_sandbox_replay_case.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_sandbox_run.baseline_id IS '单次沙盘运行冻结基线标识';
COMMENT ON COLUMN mk_sandbox_run.runtime_release_ref IS '当前模式保存医院运行发布 ID；历史模式保存来源运行修订不可逆引用';
COMMENT ON COLUMN mk_sandbox_run.runtime_revision_no IS '本次冻结的医院运行修订号';
COMMENT ON COLUMN mk_sandbox_run.platform_baseline_release_id IS 'CURRENT 与 COMPARE 模式锁定的平台权威基线发布 ID';
COMMENT ON COLUMN mk_sandbox_run.manifest_sha256 IS '医院运行修订或历史重放清单的 SHA-256 摘要';
COMMENT ON COLUMN mk_sandbox_run.resolution_source IS '业务字段：resolution_source';
COMMENT ON COLUMN mk_sandbox_run.asset_manifest_json IS '本次冻结的精确资产清单，不得在执行中重新解析';
...
COMMENT ON COLUMN mk_sandbox_run.trace_id IS '链路追踪标识';
...
COMMENT ON TABLE mk_term_mapping_snapshot IS '术语资产版本不可变映射快照：运行时仅通过医院运行修订锁定的精确版本读取';
...
COMMENT ON COLUMN mk_version_override_operation.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_version_override_template.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN mk_version_rollout_observation.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN model_capability_task.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN pathway_edge.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN pathway_milestone.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN pathway_node.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN pathway_outcome_binding.trace_id IS '链路追踪标识';
COMMENT ON TABLE pathway_template IS '路径模板版本表，模板独立维护并由运行修订选择启用版本';
...
COMMENT ON COLUMN pathway_template.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN pathway_variance.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN patient_pathway.runtime_release_id IS '患者入径时固定的医院运行修订 ID';
...
COMMENT ON COLUMN patient_pathway.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN quality_finding.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN recommendation_card.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN recommendation_fatigue_signal.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN recommendation_feedback.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN recommendation_source.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN recommendation_trigger.runtime_release_id IS '医院临床运行发布 ID';
...
COMMENT ON COLUMN recommendation_trigger.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rectification_review.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rectification_task.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_applicability.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_backtest_run.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_definition.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_drift_snapshot.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_execution_log.runtime_release_id IS '医院临床运行时锁定的不可变运行修订 ID；创作试运行可为空';
...
COMMENT ON COLUMN rule_execution_log.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_governance.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_override_log.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_shadow_feedback.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_test_case.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN rule_version.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN specialty_metric_binding.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN sys_login_attempt.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN sys_password_reset_token.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN sys_task.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN sys_task_dead_letter.trace_id IS '链路追踪标识';
...
COMMENT ON COLUMN tenant_user.trace_id IS '链路追踪标识';
...
COMMENT ON TABLE platform_baseline_release IS '平台权威基线发布账本：只追加修订并锁定完整资产清单摘要';
COMMENT ON COLUMN platform_baseline_release.id IS '数据库主键';
COMMENT ON COLUMN platform_baseline_release.baseline_release_id IS '不可变平台基线发布标识';
COMMENT ON COLUMN platform_baseline_release.revision_no IS '平台全局自动递增修订号';
COMMENT ON COLUMN platform_baseline_release.manifest_sha256 IS '完整资产清单 SHA-256 摘要';
COMMENT ON COLUMN platform_baseline_release.published_at IS '平台基线发布时间';
COMMENT ON COLUMN platform_baseline_release.published_by IS '平台基线发布操作人';
...
COMMENT ON TABLE platform_baseline_item IS '平台基线物化条目：每个稳定资产身份锁定一个精确已发布版本';
COMMENT ON COLUMN platform_baseline_item.id IS '数据库主键';
COMMENT ON COLUMN platform_baseline_item.baseline_release_id IS '所属平台基线发布标识';
...
COMMENT ON TABLE clinical_runtime_release_item IS '医院运行修订物化条目：锁定平台、集团或医院来源的精确资产版本';
COMMENT ON COLUMN clinical_runtime_release_item.id IS '数据库主键';
COMMENT ON COLUMN clinical_runtime_release_item.release_id IS '所属医院运行修订标识';
