...
CREATE TABLE mk_knowledge_authority (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    active_issuer_instance_id VARCHAR2(128),
    active_trust_root_fingerprint VARCHAR2(128),
    handover_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    release_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    lock_version NUMBER(19) DEFAULT 0 NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE mk_knowledge_issuer_instance (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    issuer_instance_id VARCHAR2(128) NOT NULL,
    display_name VARCHAR2(256) NOT NULL,
    status VARCHAR2(32) DEFAULT 'STANDBY' NOT NULL,
    last_handover_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    activated_at TIMESTAMP,
    frozen_at TIMESTAMP,
...
CREATE TABLE mk_knowledge_trust_root (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    root_fingerprint VARCHAR2(128) NOT NULL,
    root_certificate_pem CLOB NOT NULL,
    predecessor_fingerprint VARCHAR2(128),
    effective_handover_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    status VARCHAR2(32) DEFAULT 'STANDBY' NOT NULL,
    valid_from TIMESTAMP NOT NULL,
    valid_until TIMESTAMP NOT NULL,
    transition_authorized_by_key_id VARCHAR2(128),
    transition_signature CLOB,
    lock_version NUMBER(19) DEFAULT 0 NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE mk_knowledge_signing_key (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    issuer_instance_id VARCHAR2(128) NOT NULL,
    ...
    root_fingerprint VARCHAR2(128) NOT NULL,
    certificate_chain_pem CLOB NOT NULL,
    status VARCHAR2(32) DEFAULT 'STANDBY' NOT NULL,
    not_before TIMESTAMP NOT NULL,
    not_after TIMESTAMP NOT NULL,
    authorized_from_handover_sequence NUMBER(19) DEFAULT 0 NOT NULL,
    authorized_through_handover_sequence NUMBER(19),
    lock_version NUMBER(19) DEFAULT 0 NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE mk_knowledge_authority_handover (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    handover_id VARCHAR2(128) NOT NULL,
    handover_sequence NUMBER(19) NOT NULL,
    source_issuer_instance_id VARCHAR2(128) NOT NULL,
    target_issuer_instance_id VARCHAR2(128) NOT NULL,
    expected_active_issuer_instance_id VARCHAR2(128) NOT NULL,
    database_digest VARCHAR2(128),
    material_digest VARCHAR2(128),
    audit_digest VARCHAR2(128),
    registry_digest VARCHAR2(128),
    trust_chain_digest VARCHAR2(128),
    handover_manifest_digest VARCHAR2(128),
    signed_by_key_id VARCHAR2(128),
    signature CLOB,
    status VARCHAR2(32) DEFAULT 'DRAFT' NOT NULL,
    frozen_at TIMESTAMP,
...
CREATE TABLE mk_knowledge_key_revocation (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    revocation_id VARCHAR2(128) NOT NULL,
    revocation_sequence NUMBER(19) NOT NULL,
    key_id VARCHAR2(128) NOT NULL,
    effective_release_sequence NUMBER(19) NOT NULL,
    reason VARCHAR2(512) NOT NULL,
    signed_by_key_id VARCHAR2(128) NOT NULL,
...
CREATE TABLE mk_knowledge_package_registration (
    id NUMBER(19) IDENTITY NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    delivery_id VARCHAR2(128) NOT NULL,
    release_sequence NUMBER(19) NOT NULL,
    manifest_digest VARCHAR2(128) NOT NULL,
    platform_release_identity VARCHAR2(128) NOT NULL,
    package_file_digest VARCHAR2(128) NOT NULL,
    package_file_size NUMBER(19) NOT NULL,
    storage_coordinate VARCHAR2(512) NOT NULL,
    issuer_instance_id VARCHAR2(128) NOT NULL,
    key_id VARCHAR2(128) NOT NULL,
    parent_delivery_id VARCHAR2(128),
    parent_manifest_digest VARCHAR2(128),
    base_manifest_digest VARCHAR2(128),
    package_type VARCHAR2(16) NOT NULL,
    signing_status VARCHAR2(16) DEFAULT 'SIGNED' NOT NULL,
...
CREATE TABLE mk_knowledge_package_preflight (
    id NUMBER(19) IDENTITY NOT NULL,
    preflight_id VARCHAR2(96) NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    hospital_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    delivery_id VARCHAR2(128) NOT NULL,
    ...
    package_file_digest VARCHAR2(128) NOT NULL,
    package_file_size NUMBER(19) NOT NULL,
    quarantine_coordinate VARCHAR2(512) NOT NULL,
    issuer_instance_id VARCHAR2(128) NOT NULL,
    key_id VARCHAR2(128) NOT NULL,
    root_fingerprint VARCHAR2(128) NOT NULL,
    status VARCHAR2(16) DEFAULT 'PASSED' NOT NULL,
    preview_digest VARCHAR2(128) NOT NULL,
...
CREATE TABLE mk_version_asset_provenance (
    id NUMBER(19) IDENTITY NOT NULL,
    ...
    provenance_digest VARCHAR2(128) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
...
CREATE TABLE mk_knowledge_package_withdrawal (
    id NUMBER(19) IDENTITY NOT NULL,
    withdrawal_id VARCHAR2(64) NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    delivery_id VARCHAR2(128) NOT NULL,
    release_sequence NUMBER(19) NOT NULL,
    asset_type VARCHAR2(32) NOT NULL,
    asset_identity VARCHAR2(128) NOT NULL,
    withdrawn_version_id VARCHAR2(64) NOT NULL,
    successor_version_id VARCHAR2(64),
    reason_digest VARCHAR2(128) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR2(64) DEFAULT 'system' NOT NULL,
...
CREATE TABLE mk_knowledge_package_activation (
    id NUMBER(19) IDENTITY NOT NULL,
    activation_id VARCHAR2(64) NOT NULL,
    preflight_id VARCHAR2(64) NOT NULL,
    tenant_id VARCHAR2(64) NOT NULL,
    hospital_id VARCHAR2(64) NOT NULL,
    authority_id VARCHAR2(128) NOT NULL,
    delivery_id VARCHAR2(128) NOT NULL,
    preview_digest VARCHAR2(128) NOT NULL,
    expected_current_release_id VARCHAR2(64),
    runtime_release_id VARCHAR2(64) NOT NULL,
    runtime_revision_no NUMBER(19) NOT NULL,
    baseline_release_id VARCHAR2(64) NOT NULL,
    activated_at TIMESTAMP NOT NULL,
    activated_by VARCHAR2(64) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT pk_mk_knowledge_authority PRIMARY KEY (id);
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT uk_mk_knowledge_authority_tenant UNIQUE (tenant_id);
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT uk_mk_knowledge_authority_identity UNIQUE (tenant_id, authority_id);
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT ck_mk_knowledge_authority_tenant CHECK (tenant_id = 't-1');
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT ck_mk_knowledge_authority_handover_seq CHECK (handover_sequence >= 0);
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT ck_mk_knowledge_authority_release_seq CHECK (release_sequence >= 0);
ALTER TABLE mk_knowledge_issuer_instance ADD CONSTRAINT pk_mk_knowledge_issuer_instance PRIMARY KEY (id);
ALTER TABLE mk_knowledge_issuer_instance ADD CONSTRAINT uk_mk_knowledge_issuer_identity UNIQUE (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_issuer_instance ADD CONSTRAINT ck_mk_knowledge_issuer_status CHECK (status IN('STANDBY', 'ACTIVE', 'FROZEN', 'HANDED_OVER', 'REVOKED'));
ALTER TABLE mk_knowledge_issuer_instance ADD CONSTRAINT ck_mk_knowledge_issuer_handover_seq CHECK (last_handover_sequence >= 0);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT pk_mk_knowledge_trust_root PRIMARY KEY (id);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT uk_mk_knowledge_trust_root_identity UNIQUE (tenant_id, authority_id, root_fingerprint);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT ck_mk_knowledge_trust_root_status CHECK (status IN('STANDBY', 'ACTIVE', 'RETIRED', 'REVOKED'));
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT ck_mk_knowledge_trust_root_handover_seq CHECK (effective_handover_sequence >= 0);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT ck_mk_knowledge_trust_root_validity CHECK (valid_until > valid_from);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT pk_mk_knowledge_signing_key PRIMARY KEY (id);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT uk_mk_knowledge_signing_key_identity UNIQUE (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT ck_mk_knowledge_signing_key_status CHECK (status IN('STANDBY', 'ACTIVE', 'DISABLED', 'REVOKED'));
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT ck_mk_knowledge_signing_key_validity CHECK (not_after > not_before);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT ck_mk_knowledge_signing_key_handover_range CHECK (authorized_from_handover_sequence >= 0 AND (authorized_through_handover_sequence IS NULL OR authorized_through_handover_sequence >= authorized_from_handover_sequence));
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT pk_mk_knowledge_authority_handover PRIMARY KEY (id);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT uk_mk_knowledge_handover_identity UNIQUE (tenant_id, authority_id, handover_id);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT uk_mk_knowledge_handover_sequence UNIQUE (tenant_id, authority_id, handover_sequence);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT ck_mk_knowledge_handover_sequence CHECK (handover_sequence >= 1);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT ck_mk_knowledge_handover_status CHECK (status IN('DRAFT', 'FROZEN', 'VERIFIED', 'ACTIVATED', 'ABORTED'));
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT pk_mk_knowledge_key_revocation PRIMARY KEY (id);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT uk_mk_knowledge_revocation_identity UNIQUE (tenant_id, authority_id, revocation_id);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT uk_mk_knowledge_revocation_sequence UNIQUE (tenant_id, authority_id, revocation_sequence);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT uk_mk_knowledge_revocation_key UNIQUE (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT ck_mk_knowledge_revocation_sequence CHECK (revocation_sequence >= 1);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT ck_mk_knowledge_revocation_release_seq CHECK (effective_release_sequence >= 0);
ALTER TABLE mk_knowledge_package_registration ADD CONSTRAINT pk_mk_knowledge_package_registration PRIMARY KEY (id);
ALTER TABLE mk_knowledge_package_registration ADD CONSTRAINT uk_mk_knowledge_delivery_identity UNIQUE (tenant_id, authority_id, delivery_id);
...
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT pk_mk_knowledge_package_preflight PRIMARY KEY (id);
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT uk_mk_knowledge_preflight_id UNIQUE (preflight_id);
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_release_seq CHECK (release_sequence >= 1);
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_manifest_digest CHECK (REGEXP_LIKE(manifest_digest, '^sm3:[0-9a-f]{64}$'));
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_file_digest CHECK (REGEXP_LIKE(package_file_digest, '^sm3:[0-9a-f]{64}$'));
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_file_size CHECK (package_file_size >= 1);
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_quarantine CHECK (REGEXP_LIKE(quarantine_coordinate, '^objects/[0-9a-f]{2}/[0-9a-f]{64}\.mkp$'));
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_root CHECK (REGEXP_LIKE(root_fingerprint, '^sm3:[0-9a-f]{64}$'));
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_preview CHECK (REGEXP_LIKE(preview_digest, '^sm3:[0-9a-f]{64}$'));
ALTER TABLE mk_knowledge_package_preflight ADD CONSTRAINT ck_mk_knowledge_preflight_status CHECK (status = 'PASSED');
ALTER TABLE mk_version_asset_provenance ADD CONSTRAINT pk_mk_version_asset_provenance PRIMARY KEY (id);
ALTER TABLE mk_version_asset_provenance ADD CONSTRAINT uk_mk_version_asset_provenance_id UNIQUE (provenance_id);
ALTER TABLE mk_version_asset_provenance ADD CONSTRAINT uk_mk_version_asset_provenance_version UNIQUE (tenant_id, version_id);
ALTER TABLE mk_version_asset_provenance ADD CONSTRAINT ck_mk_version_asset_provenance_digest CHECK (REGEXP_LIKE(provenance_digest, '^sm3:[0-9a-f]{64}$'));
ALTER TABLE mk_version_asset_provenance ADD CONSTRAINT ck_mk_version_asset_provenance_type CHECK (asset_type IN('KNOWLEDGE', 'TERMINOLOGY', 'RULE', 'PATHWAY', 'EVALUATION', 'FOLLOWUP', 'FIELD_CATALOG', 'SAFETY', 'CDSS_RISK', 'VALUE_SET', 'FORMULA', 'ORDER_SET', 'ACTION_CARD'));
ALTER TABLE mk_knowledge_package_withdrawal ADD CONSTRAINT pk_mk_knowledge_package_withdrawal PRIMARY KEY (id);
ALTER TABLE mk_knowledge_package_withdrawal ADD CONSTRAINT uk_mk_knowledge_package_withdrawal_id UNIQUE (withdrawal_id);
ALTER TABLE mk_knowledge_package_withdrawal ADD CONSTRAINT uk_mk_knowledge_package_withdrawal_fact UNIQUE (tenant_id, authority_id, delivery_id, asset_type, asset_identity, withdrawn_version_id);
ALTER TABLE mk_knowledge_package_withdrawal ADD CONSTRAINT ck_mk_knowledge_package_withdrawal_sequence CHECK (release_sequence >= 1);
ALTER TABLE mk_knowledge_package_withdrawal ADD CONSTRAINT ck_mk_knowledge_package_withdrawal_reason CHECK (REGEXP_LIKE(reason_digest, '^(sm3|sha256):[0-9a-f]{64}$'));
ALTER TABLE mk_knowledge_package_withdrawal ADD CONSTRAINT ck_mk_knowledge_package_withdrawal_type CHECK (asset_type IN('KNOWLEDGE', 'TERMINOLOGY', 'RULE', 'PATHWAY', 'EVALUATION', 'FOLLOWUP', 'FIELD_CATALOG', 'SAFETY', 'CDSS_RISK', 'VALUE_SET', 'FORMULA', 'ORDER_SET', 'ACTION_CARD'));
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT pk_mk_knowledge_package_activation PRIMARY KEY (id);
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT uk_mk_knowledge_package_activation_id UNIQUE (activation_id);
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT uk_mk_knowledge_package_activation_preflight UNIQUE (preflight_id);
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT uk_mk_knowledge_package_activation_runtime UNIQUE (runtime_release_id);
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT ck_mk_knowledge_package_activation_preview CHECK (REGEXP_LIKE(preview_digest, '^sm3:[0-9a-f]{64}$'));
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT ck_mk_knowledge_package_activation_revision CHECK (runtime_revision_no >= 1);
...
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT fk_mk_knowledge_authority_active_issuer FOREIGN KEY (tenant_id, authority_id, active_issuer_instance_id) REFERENCES mk_knowledge_issuer_instance (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_authority ADD CONSTRAINT fk_mk_knowledge_authority_active_root FOREIGN KEY (tenant_id, authority_id, active_trust_root_fingerprint) REFERENCES mk_knowledge_trust_root (tenant_id, authority_id, root_fingerprint);
ALTER TABLE mk_knowledge_issuer_instance ADD CONSTRAINT fk_mk_knowledge_issuer_instance_authority FOREIGN KEY (tenant_id, authority_id) REFERENCES mk_knowledge_authority (tenant_id, authority_id);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT fk_mk_knowledge_trust_root_authority FOREIGN KEY (tenant_id, authority_id) REFERENCES mk_knowledge_authority (tenant_id, authority_id);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT fk_mk_knowledge_trust_root_predecessor FOREIGN KEY (tenant_id, authority_id, predecessor_fingerprint) REFERENCES mk_knowledge_trust_root (tenant_id, authority_id, root_fingerprint);
ALTER TABLE mk_knowledge_trust_root ADD CONSTRAINT fk_mk_knowledge_trust_root_transition_key FOREIGN KEY (tenant_id, authority_id, transition_authorized_by_key_id) REFERENCES mk_knowledge_signing_key (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT fk_mk_knowledge_signing_key_authority FOREIGN KEY (tenant_id, authority_id) REFERENCES mk_knowledge_authority (tenant_id, authority_id);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT fk_mk_knowledge_signing_key_issuer FOREIGN KEY (tenant_id, authority_id, issuer_instance_id) REFERENCES mk_knowledge_issuer_instance (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_signing_key ADD CONSTRAINT fk_mk_knowledge_signing_key_root FOREIGN KEY (tenant_id, authority_id, root_fingerprint) REFERENCES mk_knowledge_trust_root (tenant_id, authority_id, root_fingerprint);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT fk_mk_knowledge_authority_handover_authority FOREIGN KEY (tenant_id, authority_id) REFERENCES mk_knowledge_authority (tenant_id, authority_id);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT fk_mk_knowledge_handover_source FOREIGN KEY (tenant_id, authority_id, source_issuer_instance_id) REFERENCES mk_knowledge_issuer_instance (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT fk_mk_knowledge_handover_target FOREIGN KEY (tenant_id, authority_id, target_issuer_instance_id) REFERENCES mk_knowledge_issuer_instance (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT fk_mk_knowledge_handover_expected FOREIGN KEY (tenant_id, authority_id, expected_active_issuer_instance_id) REFERENCES mk_knowledge_issuer_instance (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_authority_handover ADD CONSTRAINT fk_mk_knowledge_handover_signing_key FOREIGN KEY (tenant_id, authority_id, signed_by_key_id) REFERENCES mk_knowledge_signing_key (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT fk_mk_knowledge_key_revocation_authority FOREIGN KEY (tenant_id, authority_id) REFERENCES mk_knowledge_authority (tenant_id, authority_id);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT fk_mk_knowledge_revocation_target_key FOREIGN KEY (tenant_id, authority_id, key_id) REFERENCES mk_knowledge_signing_key (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_key_revocation ADD CONSTRAINT fk_mk_knowledge_revocation_signing_key FOREIGN KEY (tenant_id, authority_id, signed_by_key_id) REFERENCES mk_knowledge_signing_key (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_package_registration ADD CONSTRAINT fk_mk_knowledge_package_registration_authority FOREIGN KEY (tenant_id, authority_id) REFERENCES mk_knowledge_authority (tenant_id, authority_id);
ALTER TABLE mk_knowledge_package_registration ADD CONSTRAINT fk_mk_knowledge_delivery_issuer FOREIGN KEY (tenant_id, authority_id, issuer_instance_id) REFERENCES mk_knowledge_issuer_instance (tenant_id, authority_id, issuer_instance_id);
ALTER TABLE mk_knowledge_package_registration ADD CONSTRAINT fk_mk_knowledge_delivery_signing_key FOREIGN KEY (tenant_id, authority_id, key_id) REFERENCES mk_knowledge_signing_key (tenant_id, authority_id, key_id);
ALTER TABLE mk_knowledge_package_registration ADD CONSTRAINT fk_mk_knowledge_delivery_parent FOREIGN KEY (tenant_id, authority_id, parent_delivery_id) REFERENCES mk_knowledge_package_registration (tenant_id, authority_id, delivery_id);
ALTER TABLE mk_version_asset_provenance ADD CONSTRAINT fk_mk_version_asset_provenance_version FOREIGN KEY (version_id) REFERENCES mk_version_asset_version (version_id) ON DELETE CASCADE;
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT fk_mk_knowledge_package_activation_preflight FOREIGN KEY (preflight_id) REFERENCES mk_knowledge_package_preflight (preflight_id);
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT fk_mk_knowledge_package_activation_runtime FOREIGN KEY (runtime_release_id) REFERENCES clinical_runtime_release (release_id);
ALTER TABLE mk_knowledge_package_activation ADD CONSTRAINT fk_mk_knowledge_package_activation_baseline FOREIGN KEY (baseline_release_id) REFERENCES platform_baseline_release (baseline_release_id);
...
CREATE INDEX idx_mk_knowledge_issuer_status ON mk_knowledge_issuer_instance (tenant_id, authority_id, status);
CREATE INDEX idx_mk_knowledge_issuer_created ON mk_knowledge_issuer_instance (tenant_id, authority_id, created_at, id);
CREATE INDEX idx_mk_knowledge_trust_root_status ON mk_knowledge_trust_root (tenant_id, authority_id, status, effective_handover_sequence);
CREATE INDEX idx_mk_knowledge_signing_key_issuer ON mk_knowledge_signing_key (tenant_id, authority_id, issuer_instance_id, status);
CREATE INDEX idx_mk_knowledge_handover_status ON mk_knowledge_authority_handover (tenant_id, authority_id, status, handover_sequence);
CREATE INDEX idx_mk_knowledge_delivery_issuer ON mk_knowledge_package_registration (tenant_id, authority_id, issuer_instance_id, release_sequence);
CREATE INDEX idx_mk_knowledge_preflight_recent ON mk_knowledge_package_preflight (tenant_id, hospital_id, created_at DESC);
CREATE INDEX idx_mk_knowledge_preflight_replay ON mk_knowledge_package_preflight (tenant_id, hospital_id, authority_id, release_sequence DESC, created_at DESC);
CREATE INDEX idx_mk_version_asset_provenance_delivery ON mk_version_asset_provenance (tenant_id, authority_id, delivery_id);
CREATE INDEX idx_mk_knowledge_package_withdrawal_version ON mk_knowledge_package_withdrawal (tenant_id, withdrawn_version_id);
CREATE INDEX idx_mk_knowledge_package_activation_hospital ON mk_knowledge_package_activation (tenant_id, hospital_id, activated_at DESC);
...
COMMENT ON TABLE mk_knowledge_authority IS '平台知识权威稳定身份与当前签发游标';
COMMENT ON COLUMN mk_knowledge_authority.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_authority.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_authority.authority_id IS '与宿主环境解耦的权威稳定标识';
COMMENT ON COLUMN mk_knowledge_authority.active_issuer_instance_id IS '当前唯一活动签发实例标识';
COMMENT ON COLUMN mk_knowledge_authority.active_trust_root_fingerprint IS '当前活动公开信任根指纹';
COMMENT ON COLUMN mk_knowledge_authority.handover_sequence IS '已激活的权威交接序号';
COMMENT ON COLUMN mk_knowledge_authority.release_sequence IS '已注册的医疗资源发布序号';
COMMENT ON COLUMN mk_knowledge_authority.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_authority.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_authority.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_authority.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_authority.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_authority.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_issuer_instance IS '平台知识权威签发实例生命周期';
COMMENT ON COLUMN mk_knowledge_issuer_instance.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_issuer_instance.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_issuer_instance.authority_id IS '平台知识权威稳定标识';
COMMENT ON COLUMN mk_knowledge_issuer_instance.issuer_instance_id IS '与宿主地址解耦的签发实例标识';
COMMENT ON COLUMN mk_knowledge_issuer_instance.display_name IS '签发实例中文展示名称';
COMMENT ON COLUMN mk_knowledge_issuer_instance.status IS '签发实例生命周期状态';
COMMENT ON COLUMN mk_knowledge_issuer_instance.last_handover_sequence IS '实例已接受的最后交接序号';
COMMENT ON COLUMN mk_knowledge_issuer_instance.activated_at IS '实例激活时间';
COMMENT ON COLUMN mk_knowledge_issuer_instance.frozen_at IS '实例冻结时间';
COMMENT ON COLUMN mk_knowledge_issuer_instance.handed_over_at IS '实例完成交接时间';
COMMENT ON COLUMN mk_knowledge_issuer_instance.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_issuer_instance.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_issuer_instance.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_issuer_instance.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_issuer_instance.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_issuer_instance.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_trust_root IS '平台知识权威公开信任根及根轮换证明';
COMMENT ON COLUMN mk_knowledge_trust_root.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_trust_root.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_trust_root.authority_id IS '平台知识权威稳定标识';
COMMENT ON COLUMN mk_knowledge_trust_root.root_fingerprint IS '公开信任根证书指纹';
COMMENT ON COLUMN mk_knowledge_trust_root.root_certificate_pem IS '公开信任根证书内容';
COMMENT ON COLUMN mk_knowledge_trust_root.predecessor_fingerprint IS '前任公开信任根指纹';
COMMENT ON COLUMN mk_knowledge_trust_root.effective_handover_sequence IS '信任根生效交接序号';
COMMENT ON COLUMN mk_knowledge_trust_root.status IS '公开信任根生命周期状态';
COMMENT ON COLUMN mk_knowledge_trust_root.valid_from IS '信任根有效期起点';
COMMENT ON COLUMN mk_knowledge_trust_root.valid_until IS '信任根有效期终点';
COMMENT ON COLUMN mk_knowledge_trust_root.transition_authorized_by_key_id IS '授权根轮换的签名密钥标识';
COMMENT ON COLUMN mk_knowledge_trust_root.transition_signature IS '旧根授权的轮换签名';
COMMENT ON COLUMN mk_knowledge_trust_root.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_trust_root.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_trust_root.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_trust_root.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_trust_root.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_trust_root.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_signing_key IS '平台知识发布签名公钥与外置密钥授权边界';
COMMENT ON COLUMN mk_knowledge_signing_key.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_signing_key.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_signing_key.authority_id IS '平台知识权威稳定标识';
COMMENT ON COLUMN mk_knowledge_signing_key.issuer_instance_id IS '密钥所属签发实例标识';
COMMENT ON COLUMN mk_knowledge_signing_key.key_id IS '外置签名密钥公开标识';
COMMENT ON COLUMN mk_knowledge_signing_key.root_fingerprint IS '签名证书所属公开信任根指纹';
COMMENT ON COLUMN mk_knowledge_signing_key.certificate_chain_pem IS '签名公钥证书链内容';
COMMENT ON COLUMN mk_knowledge_signing_key.status IS '签名密钥生命周期状态';
COMMENT ON COLUMN mk_knowledge_signing_key.not_before IS '密钥授权生效时间';
COMMENT ON COLUMN mk_knowledge_signing_key.not_after IS '密钥授权失效时间';
COMMENT ON COLUMN mk_knowledge_signing_key.authorized_from_handover_sequence IS '密钥授权起始交接序号';
COMMENT ON COLUMN mk_knowledge_signing_key.authorized_through_handover_sequence IS '密钥授权终止交接序号';
COMMENT ON COLUMN mk_knowledge_signing_key.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_signing_key.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_signing_key.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_signing_key.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_signing_key.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_signing_key.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_authority_handover IS '平台知识权威签署交接清单与激活事实';
COMMENT ON COLUMN mk_knowledge_authority_handover.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_authority_handover.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.authority_id IS '平台知识权威稳定标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.handover_id IS '权威交接不可变标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.handover_sequence IS '严格递增的权威交接序号';
COMMENT ON COLUMN mk_knowledge_authority_handover.source_issuer_instance_id IS '交接来源签发实例标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.target_issuer_instance_id IS '交接目标签发实例标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.expected_active_issuer_instance_id IS '冻结时预期的活动签发实例标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.database_digest IS '权威数据库快照摘要';
COMMENT ON COLUMN mk_knowledge_authority_handover.material_digest IS '医疗资料原件摘要';
COMMENT ON COLUMN mk_knowledge_authority_handover.audit_digest IS '审计链摘要';
COMMENT ON COLUMN mk_knowledge_authority_handover.registry_digest IS '交付制品注册表摘要';
COMMENT ON COLUMN mk_knowledge_authority_handover.trust_chain_digest IS '公开信任链摘要';
COMMENT ON COLUMN mk_knowledge_authority_handover.handover_manifest_digest IS '权威交接目录校验码';
COMMENT ON COLUMN mk_knowledge_authority_handover.signed_by_key_id IS '交接清单签名密钥标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.signature IS '交接清单数字签名';
COMMENT ON COLUMN mk_knowledge_authority_handover.status IS '权威交接生命周期状态';
COMMENT ON COLUMN mk_knowledge_authority_handover.frozen_at IS '权威冻结时间';
COMMENT ON COLUMN mk_knowledge_authority_handover.verified_at IS '交接验证完成时间';
COMMENT ON COLUMN mk_knowledge_authority_handover.activated_at IS '目标实例激活时间';
COMMENT ON COLUMN mk_knowledge_authority_handover.aborted_at IS '交接中止时间';
COMMENT ON COLUMN mk_knowledge_authority_handover.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_authority_handover.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_authority_handover.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_authority_handover.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_authority_handover.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_key_revocation IS '平台知识签名密钥单调吊销事实';
COMMENT ON COLUMN mk_knowledge_key_revocation.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_key_revocation.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.authority_id IS '平台知识权威稳定标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.revocation_id IS '密钥吊销事实不可变标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.revocation_sequence IS '严格递增的密钥吊销序号';
COMMENT ON COLUMN mk_knowledge_key_revocation.key_id IS '被吊销的签名密钥标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.effective_release_sequence IS '吊销开始生效的医疗资源发布序号';
COMMENT ON COLUMN mk_knowledge_key_revocation.reason IS '密钥吊销原因';
COMMENT ON COLUMN mk_knowledge_key_revocation.signed_by_key_id IS '吊销事实签名密钥标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.signature IS '吊销事实数字签名';
COMMENT ON COLUMN mk_knowledge_key_revocation.revoked_at IS '密钥吊销时间';
COMMENT ON COLUMN mk_knowledge_key_revocation.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_key_revocation.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_key_revocation.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_key_revocation.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_key_revocation.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_package_registration IS '平台知识医疗资源交付制品不可变注册事实';
COMMENT ON COLUMN mk_knowledge_package_registration.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_package_registration.tenant_id IS '平台租户标识';
COMMENT ON COLUMN mk_knowledge_package_registration.authority_id IS '平台知识权威稳定标识';
...
COMMENT ON COLUMN mk_knowledge_package_registration.parent_manifest_digest IS '直接父级交付制品目录校验码';
COMMENT ON COLUMN mk_knowledge_package_registration.base_manifest_digest IS '差量适用的初始完整交付目录校验码';
COMMENT ON COLUMN mk_knowledge_package_registration.package_type IS '医疗资源交付类型';
COMMENT ON COLUMN mk_knowledge_package_registration.signing_status IS '交付制品签发状态';
COMMENT ON COLUMN mk_knowledge_package_registration.signed_at IS '交付制品完成签名时间';
COMMENT ON COLUMN mk_knowledge_package_registration.registered_at IS '交付制品登记时间';
COMMENT ON COLUMN mk_knowledge_package_registration.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_package_registration.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_package_registration.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_package_registration.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_package_registration.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_package_registration.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_package_preflight IS '医院完整医疗资源包通过固定根验签后的不可变只读预检事实';
COMMENT ON COLUMN mk_knowledge_package_preflight.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_package_preflight.preflight_id IS '绑定目标医院、包摘要和医院状态快照的稳定预检标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.tenant_id IS '目标医院所属租户标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.hospital_id IS '执行只读预检的目标医院标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.authority_id IS '已由院内固定信任根确认的平台知识权威标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.delivery_id IS '便携医疗资源交付制品标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.release_sequence IS '已通过防重放校验的医疗资源发布序号';
COMMENT ON COLUMN mk_knowledge_package_preflight.manifest_digest IS '已验签的包目录 SM3 摘要';
COMMENT ON COLUMN mk_knowledge_package_preflight.platform_release_identity IS '包内平台标准版本稳定标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.package_file_digest IS '隔离区完整包真实字节的 SM3 摘要';
COMMENT ON COLUMN mk_knowledge_package_preflight.package_file_size IS '隔离区完整包真实字节数';
COMMENT ON COLUMN mk_knowledge_package_preflight.quarantine_coordinate IS '与宿主根目录无关的受管隔离区相对坐标';
COMMENT ON COLUMN mk_knowledge_package_preflight.issuer_instance_id IS '已验签的交付制品签发实例标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.key_id IS '已验签的交付制品签名密钥标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.root_fingerprint IS '院内预置固定信任根的 SM3 指纹';
COMMENT ON COLUMN mk_knowledge_package_preflight.status IS '不可变预检状态，仅持久化通过事实';
COMMENT ON COLUMN mk_knowledge_package_preflight.preview_digest IS '不可变预览正文的 SM3 摘要';
COMMENT ON COLUMN mk_knowledge_package_preflight.preview_json IS '绑定包清单与目标医院当前状态的差异、冲突、依赖和撤回预览';
COMMENT ON COLUMN mk_knowledge_package_preflight.lock_version IS '乐观锁版本号';
COMMENT ON COLUMN mk_knowledge_package_preflight.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_package_preflight.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_package_preflight.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_package_preflight.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_version_asset_provenance IS '可移植资产来源事实：保留来源、许可、精确依赖、校验和合成测试，不重复保存正文';
COMMENT ON COLUMN mk_version_asset_provenance.id IS '数据库内部主键';
COMMENT ON COLUMN mk_version_asset_provenance.provenance_id IS '由权威、版本和来源事实摘要确定性派生的稳定标识';
COMMENT ON COLUMN mk_version_asset_provenance.tenant_id IS '资产所属租户；完整包平台资产固定为 t-1';
COMMENT ON COLUMN mk_version_asset_provenance.authority_id IS '首次恢复该不可变版本的平台知识权威标识';
COMMENT ON COLUMN mk_version_asset_provenance.delivery_id IS '首次恢复该不可变版本的交付制品标识';
COMMENT ON COLUMN mk_version_asset_provenance.asset_type IS '统一版本化资产类型';
COMMENT ON COLUMN mk_version_asset_provenance.asset_identity IS '跨实例稳定资产身份';
COMMENT ON COLUMN mk_version_asset_provenance.version_id IS '精确绑定的不可变资产版本标识';
COMMENT ON COLUMN mk_version_asset_provenance.provenance_json IS '规范编码的来源、许可、依赖、校验和合成测试事实';
COMMENT ON COLUMN mk_version_asset_provenance.provenance_digest IS '来源事实规范字节的 SM3 摘要';
COMMENT ON COLUMN mk_version_asset_provenance.created_at IS '创建时间';
COMMENT ON COLUMN mk_version_asset_provenance.created_by IS '创建人标识';
COMMENT ON COLUMN mk_version_asset_provenance.updated_at IS '更新时间';
COMMENT ON COLUMN mk_version_asset_provenance.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_version_asset_provenance.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_package_withdrawal IS '完整医疗资源包安全撤回事实：即使空库不存在被撤回正文也永久保留';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.withdrawal_id IS '由交付和被撤回版本确定性派生的稳定标识';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.tenant_id IS '撤回事实所属平台租户';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.authority_id IS '签发撤回事实的平台知识权威标识';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.delivery_id IS '携带撤回事实的交付制品标识';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.release_sequence IS '权威内单调医疗资源发布序号';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.asset_type IS '被撤回资产类型';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.asset_identity IS '被撤回资产稳定身份';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.withdrawn_version_id IS '被撤回不可变版本标识；允许本地尚无该版本';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.successor_version_id IS '安全替代版本标识；为空表示尚无替代版本';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.reason_digest IS '撤回原因不可变正文摘要';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_package_withdrawal.trace_id IS '全链路追踪标识';
COMMENT ON TABLE mk_knowledge_package_activation IS '完整医疗资源包机构激活账本：绑定预检确认、期望当前版本和新机构修订，支撑网络重试幂等';
COMMENT ON COLUMN mk_knowledge_package_activation.id IS '数据库内部主键';
COMMENT ON COLUMN mk_knowledge_package_activation.activation_id IS '由预检和新机构版本确定性派生的稳定激活标识';
COMMENT ON COLUMN mk_knowledge_package_activation.preflight_id IS '精确绑定的不可变包预检标识';
COMMENT ON COLUMN mk_knowledge_package_activation.tenant_id IS '目标医院所属租户';
COMMENT ON COLUMN mk_knowledge_package_activation.hospital_id IS '目标医院标识';
COMMENT ON COLUMN mk_knowledge_package_activation.authority_id IS '已验签平台知识权威标识';
COMMENT ON COLUMN mk_knowledge_package_activation.delivery_id IS '已激活交付制品标识';
COMMENT ON COLUMN mk_knowledge_package_activation.preview_digest IS '操作者确认且激活前重新计算一致的预览摘要';
COMMENT ON COLUMN mk_knowledge_package_activation.expected_current_release_id IS '首次激活为空，升级时为操作者确认的当前机构版本';
COMMENT ON COLUMN mk_knowledge_package_activation.runtime_release_id IS '原子激活产生的不可变机构生效版本标识';
COMMENT ON COLUMN mk_knowledge_package_activation.runtime_revision_no IS '原子激活产生的机构内单调修订号';
COMMENT ON COLUMN mk_knowledge_package_activation.baseline_release_id IS '本次机构版本采用的平台标准版本标识';
COMMENT ON COLUMN mk_knowledge_package_activation.activated_at IS '原子激活完成时间';
COMMENT ON COLUMN mk_knowledge_package_activation.activated_by IS '激活操作人标识';
COMMENT ON COLUMN mk_knowledge_package_activation.created_at IS '创建时间';
COMMENT ON COLUMN mk_knowledge_package_activation.created_by IS '创建人标识';
COMMENT ON COLUMN mk_knowledge_package_activation.updated_at IS '更新时间';
COMMENT ON COLUMN mk_knowledge_package_activation.updated_by IS '更新人标识';
COMMENT ON COLUMN mk_knowledge_package_activation.trace_id IS '全链路追踪标识';
