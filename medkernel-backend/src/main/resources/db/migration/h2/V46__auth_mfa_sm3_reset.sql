-- MedKernel AUTH-03 · MFA / SM3 / 受控重置（H2 2.2）
ALTER TABLE platform_credential ALTER COLUMN password_hash SET DATA TYPE VARCHAR(255);
ALTER TABLE platform_credential ALTER COLUMN mfa_secret SET DATA TYPE VARCHAR(512);
