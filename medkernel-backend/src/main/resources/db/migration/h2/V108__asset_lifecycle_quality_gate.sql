-- MedKernel v1.0 GA · 统一资产生命周期与发布质量门（H2）
...
ALTER TABLE mk_version_release_plan ADD COLUMN IF NOT EXISTS electronic_signature_id VARCHAR(128) NULL;
ALTER TABLE mk_version_release_plan ADD COLUMN IF NOT EXISTS electronic_signature_subject VARCHAR(256) NULL;
ALTER TABLE mk_version_release_plan ADD COLUMN IF NOT EXISTS electronic_signature_hash VARCHAR(64) NULL;
ALTER TABLE mk_version_release_plan ADD COLUMN IF NOT EXISTS electronic_signature_signed_at TIMESTAMP NULL;
ALTER TABLE mk_version_release_plan ADD COLUMN IF NOT EXISTS quality_gate_summary VARCHAR(2048) NULL;
...
ALTER TABLE mk_version_activation_transaction DROP CONSTRAINT IF EXISTS ck_mk_version_activation_transaction_action;
