-- MedKernel v1.0 GA · 知识循证与复审治理（H2）
...
ALTER TABLE knowledge_asset_version ADD COLUMN IF NOT EXISTS next_review_at TIMESTAMP NULL;
...
ALTER TABLE knowledge_supersession ADD COLUMN IF NOT EXISTS grace_period_end TIMESTAMP NULL;
