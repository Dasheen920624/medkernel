-- MedKernel v1.0 GA · SVC-COMPLIANCE-01 外部身份绑定（Oracle）
...
CREATE TABLE mk_compliance_identity_binding (
    ...
    unbound_reason          VARCHAR2(512) NULL,
...
CREATE INDEX idx_compliance_identity_binding_user
    ON mk_compliance_identity_binding (tenant_id, user_id, provider_type, status);
CREATE INDEX idx_compliance_identity_binding_status
