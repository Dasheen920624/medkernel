...
ALTER TABLE knowledge_supersession ADD (
    successor_identity_id NUMBER(19) NULL,
    grace_period_end TIMESTAMP WITH TIME ZONE NULL,
    migration_guidance VARCHAR2(1000) NULL
);
