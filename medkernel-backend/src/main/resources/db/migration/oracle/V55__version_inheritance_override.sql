-- MedKernel v1.0 GA · SYS-04 组织继承覆盖解释（Oracle）
...
CREATE TABLE mk_version_inheritance_override (
    ...
    inherited_version_id VARCHAR2(64)   NOT NULL,
    override_version_id  VARCHAR2(64)   NULL,
...
CREATE INDEX idx_mk_version_inheritance_override_scope
    ON mk_version_inheritance_override (tenant_id, org_path, asset_type, asset_identity);
CREATE INDEX idx_mk_version_inheritance_override_version
