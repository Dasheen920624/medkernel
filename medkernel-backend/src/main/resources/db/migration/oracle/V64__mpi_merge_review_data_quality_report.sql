-- MedKernel v1.0 GA · SVC-PILOT-02 MPI 合并审核与数据质量报告（Oracle）
...
CREATE TABLE mk_mpi_merge_review (
    ...
    review_reason    VARCHAR2(512)  NULL,
...
CREATE INDEX idx_mpi_mrv_tenant_status
    ON mk_mpi_merge_review (tenant_id, status, requested_at);
CREATE INDEX idx_mpi_mrv_source
...
CREATE INDEX idx_dqr_tenant_generated
