-- MedKernel v1.0 GA · SVC-QUALITY-01 质控驾驶舱预警 read-model（Oracle）
...
CREATE TABLE mk_quality_dashboard_alert (
    ...
    threshold_value  NUMBER(18,4)   NOT NULL,
...
CREATE INDEX idx_quality_dashboard_alert_tenant_status
    ON mk_quality_dashboard_alert (tenant_id, status, updated_at);
CREATE INDEX idx_quality_dashboard_alert_department
