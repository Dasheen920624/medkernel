...
ALTER TABLE evaluation_indicator MODIFY (trace_id VARCHAR2(128 CHAR));
ALTER TABLE evaluation_run MODIFY (trace_id VARCHAR2(128 CHAR));
ALTER TABLE evaluation_result MODIFY (trace_id VARCHAR2(128 CHAR));
ALTER TABLE quality_finding MODIFY (trace_id VARCHAR2(128 CHAR));
ALTER TABLE rectification_task MODIFY (trace_id VARCHAR2(128 CHAR));
ALTER TABLE rectification_review MODIFY (trace_id VARCHAR2(128 CHAR));
ALTER TABLE evaluation_idempotency_key MODIFY (trace_id VARCHAR2(128 CHAR));
