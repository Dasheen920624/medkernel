-- MedKernel v1.0 GA · 资产依赖与引用完整性（Oracle）
...
CREATE TABLE mk_version_asset_dependency (
    ...
    min_version_no        VARCHAR2(64)  NULL,
    max_version_no        VARCHAR2(64)  NULL,
...
CREATE INDEX idx_mk_version_asset_dependency_owner
    ON mk_version_asset_dependency (tenant_id, asset_type, asset_identity, version_id);
CREATE INDEX idx_mk_version_asset_dependency_target
