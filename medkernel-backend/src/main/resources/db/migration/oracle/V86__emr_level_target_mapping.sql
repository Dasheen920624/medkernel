-- MedKernel v1.0 GA · EMR-LEVEL-01 电子病历评级目标与项目映射（Oracle）
...
CREATE TABLE mk_emr_level_target (
    ...
    progress_rate        NUMBER(7,4)    DEFAULT 0 NOT NULL,
...
CREATE INDEX idx_emr_level_target_scope
...
CREATE TABLE mk_emr_level_item (
    ...
    evidence_ref              VARCHAR2(512)  NULL,
    evidence_summary          CLOB           NOT NULL,
    responsible_department_id VARCHAR2(64)   NULL,
...
CREATE INDEX idx_emr_level_item_target
...
CREATE INDEX idx_emr_level_gap_target
    ON mk_emr_level_gap (tenant_id, target_id, gap_status);
CREATE INDEX idx_emr_level_gap_task
