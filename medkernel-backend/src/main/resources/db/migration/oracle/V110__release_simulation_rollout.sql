-- MedKernel v1.0 GA · 发布模拟、灰度放量与覆盖复用（Oracle）
...
ALTER TABLE mk_version_release_plan ADD (
    ...
    rollout_config_json CLOB NULL,
    rollout_stage_index NUMBER(10) DEFAULT 0 NOT NULL,
    rollout_paused_reason VARCHAR2(1000) NULL
);
...
CREATE TABLE mk_version_rollout_observation (
    ...
    hit_rate NUMBER(9,6) NOT NULL,
    block_rate NUMBER(9,6) NOT NULL,
    manual_rejection_rate NUMBER(9,6) NOT NULL,
    anomaly_rate NUMBER(9,6) NOT NULL,
