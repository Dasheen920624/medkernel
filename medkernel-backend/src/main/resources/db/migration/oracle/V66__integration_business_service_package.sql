-- MedKernel v1.0 GA · SVC-INTEGRATION-01 第三方业务接口服务包（Oracle）
...
CREATE TABLE mk_integration_onboarding (
    ...
    adapter_id          VARCHAR2(64)   NULL,
    fhir_version        VARCHAR2(16)   NULL,
    source_system       VARCHAR2(128)  NOT NULL,
    business_scenario   VARCHAR2(256)  NOT NULL,
    org_path            VARCHAR2(512)  NOT NULL,
    callback_webhook_id VARCHAR2(64)   NULL,
    status              VARCHAR2(32)   NOT NULL,
    evidence_text       VARCHAR2(1000) NULL,
...
CREATE INDEX idx_integ_onb_tenant_status
    ON mk_integration_onboarding (tenant_id, status, updated_at);
CREATE INDEX idx_integ_onb_adapter
...
CREATE TABLE mk_integration_regional_source (
    ...
    adapter_id               VARCHAR2(64)   NULL,
    onboarding_id            VARCHAR2(64)   NULL,
    org_path                 VARCHAR2(512)  NOT NULL,
    status                   VARCHAR2(32)   NOT NULL,
    created_at               TIMESTAMP WITH TIME ZONE NOT NULL,
    created_by               VARCHAR2(64)   NOT NULL,
...
CREATE INDEX idx_integ_regional_tenant_trust
    ON mk_integration_regional_source (tenant_id, trust_level, status);
CREATE INDEX idx_integ_regional_org
