...
CREATE INDEX idx_mk_engine_condition_fragment_code
    ON mk_engine_condition_fragment (tenant_id, fragment_code);

CREATE INDEX idx_mk_engine_condition_fragment_package
    ON mk_engine_condition_fragment (tenant_id, package_version);

CREATE INDEX idx_mk_engine_condition_fragment_status
