-- MedKernel v1.0 GA · OPT-04 临床安全红线静默试运行证据（Oracle）
...
CREATE TABLE mk_engine_clinical_redline_trial (
    ...
    operator_note               VARCHAR2(1024) NULL,
    ...
    CONSTRAINT ck_clinical_redline_trial_gate CHECK (gate_passed IN (0, 1)),
...
CREATE INDEX idx_clinical_redline_trial_redline
    ON mk_engine_clinical_redline_trial (tenant_id, redline_id, redline_version, created_at);
CREATE INDEX idx_clinical_redline_trial_status
