-- MedKernel 全新上线数据库基线（人大金仓 KingbaseES）
...
CREATE TABLE mk_knowledge_authority (
    ...
    active_issuer_instance_id VARCHAR(128),
    active_trust_root_fingerprint VARCHAR(128),
    handover_sequence BIGINT DEFAULT 0 NOT NULL,
    release_sequence BIGINT DEFAULT 0 NOT NULL,
    lock_version BIGINT DEFAULT 0 NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE mk_knowledge_issuer_instance (
    ...
    display_name VARCHAR(256) NOT NULL,
    status VARCHAR(32) DEFAULT 'STANDBY' NOT NULL,
    last_handover_sequence BIGINT DEFAULT 0 NOT NULL,
    activated_at TIMESTAMP,
    frozen_at TIMESTAMP,
...
CREATE TABLE mk_knowledge_trust_root (
    ...
    predecessor_fingerprint VARCHAR(128),
    effective_handover_sequence BIGINT DEFAULT 0 NOT NULL,
    status VARCHAR(32) DEFAULT 'STANDBY' NOT NULL,
    valid_from TIMESTAMP NOT NULL,
    valid_until TIMESTAMP NOT NULL,
    transition_authorized_by_key_id VARCHAR(128),
...
CREATE TABLE mk_knowledge_signing_key (
    ...
    authorized_from_handover_sequence BIGINT DEFAULT 0 NOT NULL,
    authorized_through_handover_sequence BIGINT,
    lock_version BIGINT DEFAULT 0 NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE TABLE mk_knowledge_authority_handover (
    ...
    handover_sequence BIGINT NOT NULL,
    source_issuer_instance_id VARCHAR(128) NOT NULL,
    target_issuer_instance_id VARCHAR(128) NOT NULL,
    expected_active_issuer_instance_id VARCHAR(128) NOT NULL,
    database_digest VARCHAR(128),
    material_digest VARCHAR(128),
    audit_digest VARCHAR(128),
    registry_digest VARCHAR(128),
    trust_chain_digest VARCHAR(128),
    handover_manifest_digest VARCHAR(128),
    signed_by_key_id VARCHAR(128),
    signature TEXT,
    status VARCHAR(32) DEFAULT 'DRAFT' NOT NULL,
    frozen_at TIMESTAMP,
...
CREATE TABLE mk_knowledge_key_revocation (
    ...
    tenant_id VARCHAR(64) NOT NULL,
    authority_id VARCHAR(128) NOT NULL,
    revocation_id VARCHAR(128) NOT NULL,
    revocation_sequence BIGINT NOT NULL,
    key_id VARCHAR(128) NOT NULL,
    effective_release_sequence BIGINT NOT NULL,
    reason VARCHAR(512) NOT NULL,
    signed_by_key_id VARCHAR(128) NOT NULL,
...
CREATE TABLE mk_knowledge_package_registration (
    ...
    parent_manifest_digest VARCHAR(128),
    base_manifest_digest VARCHAR(128),
    package_type VARCHAR(16) NOT NULL,
    signing_status VARCHAR(16) DEFAULT 'SIGNED' NOT NULL,
...
CREATE TABLE mk_knowledge_package_preflight (
    ...
    package_file_digest VARCHAR(128) NOT NULL,
    package_file_size BIGINT NOT NULL,
    quarantine_coordinate VARCHAR(512) NOT NULL,
    issuer_instance_id VARCHAR(128) NOT NULL,
    key_id VARCHAR(128) NOT NULL,
    root_fingerprint VARCHAR(128) NOT NULL,
    status VARCHAR(16) DEFAULT 'PASSED' NOT NULL,
    preview_digest VARCHAR(128) NOT NULL,
...
CREATE TABLE mk_knowledge_package_withdrawal (
    ...
    asset_type VARCHAR(32) NOT NULL,
    asset_identity VARCHAR(128) NOT NULL,
    withdrawn_version_id VARCHAR(64) NOT NULL,
    successor_version_id VARCHAR(64),
    reason_digest VARCHAR(128) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    created_by VARCHAR(64) DEFAULT 'system' NOT NULL,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_by VARCHAR(64) DEFAULT 'system' NOT NULL,
...
CREATE TABLE mk_knowledge_package_activation (
    ...
    preflight_id VARCHAR(64) NOT NULL,
    tenant_id VARCHAR(64) NOT NULL,
    hospital_id VARCHAR(64) NOT NULL,
    authority_id VARCHAR(128) NOT NULL,
    delivery_id VARCHAR(128) NOT NULL,
    preview_digest VARCHAR(128) NOT NULL,
    expected_current_release_id VARCHAR(64),
    runtime_release_id VARCHAR(64) NOT NULL,
    runtime_revision_no BIGINT NOT NULL,
    baseline_release_id VARCHAR(64) NOT NULL,
    activated_at TIMESTAMP NOT NULL,
    activated_by VARCHAR(64) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
