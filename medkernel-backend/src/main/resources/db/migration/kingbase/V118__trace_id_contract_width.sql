...
ALTER TABLE platform_credential ALTER COLUMN trace_id TYPE VARCHAR(128);
ALTER TABLE mk_security_bootstrap_init_token ALTER COLUMN trace_id TYPE VARCHAR(128);
