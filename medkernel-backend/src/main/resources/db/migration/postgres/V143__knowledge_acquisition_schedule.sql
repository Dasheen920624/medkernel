-- MedKernel 第二阶段 P2-C · AIK-STD-14 公域资料自动获取调度（PostgreSQL）
...
ALTER TABLE mk_knowledge_acquisition_source
    ADD COLUMN last_check_at TIMESTAMPTZ NULL;
ALTER TABLE mk_knowledge_acquisition_source
...
CREATE INDEX IF NOT EXISTS idx_mk_knowledge_acquisition_schedule_due
