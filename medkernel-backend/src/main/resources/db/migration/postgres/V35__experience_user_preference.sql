-- MedKernel v1.0 GA · BASE-10 用户体验偏好持久化（PostgreSQL）
...
CREATE INDEX IF NOT EXISTS idx_user_pref_user_key
...
COMMENT ON COLUMN mk_experience_user_pref.pref_value IS '偏好值，仅保存非敏感 UI 配置，不保存患者、令牌或密码信息';
