-- MedKernel v1.0 GA · BASE-04 审计脊柱完整字段（PostgreSQL 16）
...
ALTER TABLE audit_event ADD COLUMN IF NOT EXISTS before_snapshot TEXT          NULL;
ALTER TABLE audit_event ADD COLUMN IF NOT EXISTS after_snapshot  TEXT          NULL;
