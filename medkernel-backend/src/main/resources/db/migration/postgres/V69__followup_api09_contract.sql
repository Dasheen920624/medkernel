-- MedKernel v1.0 GA · API-09 随访客户面契约补强（PostgreSQL）
...
ALTER TABLE followup_questionnaire ADD COLUMN IF NOT EXISTS answer_data TEXT NULL;
ALTER TABLE followup_questionnaire ADD COLUMN IF NOT EXISTS idempotency_key VARCHAR(128) NULL;
ALTER TABLE followup_questionnaire ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMPTZ NULL;
