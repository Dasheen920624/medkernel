-- MedKernel v1.0 GA · KNOW-01/OPT-07 可信分级与冲突仲裁（PostgreSQL）
...
SET authority_level = source_document.authority_level
FROM source_document
WHERE knowledge_asset_version.source_document_id = source_document.id
  AND knowledge_asset_version.authority_level IS NULL;
