...
CREATE TABLE IF NOT EXISTS mk_engine_authoring_asset_favorite (
    id                  BIGINT       GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    tenant_id           VARCHAR(64)  NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_mk_engine_authoring_asset_profile_category
    ON mk_engine_authoring_asset_profile (tenant_id, category);

CREATE INDEX IF NOT EXISTS idx_mk_engine_authoring_asset_favorite_user
    ON mk_engine_authoring_asset_favorite (tenant_id, user_id);

CREATE INDEX IF NOT EXISTS idx_mk_engine_authoring_asset_favorite_asset
