...
public final class ServiceContractCatalog {
    private static final List<ServiceContract> CONTRACTS = List.of(
        ...
        contract("diagnosis-knowledge", "诊断知识库服务",
        ...
        contract("value-metrics", "价值指标与 ROI 服务",
            ...
            List.of()),
        contract("quality-dashboard", "质量风险概览服务",
            ...
            audits(
                audit(AuditAction.CREATE, "mk_quality_dashboard_alert", "生成质量风险概览预警视图"),
                audit(AuditAction.UPDATE, "mk_quality_dashboard_alert", "刷新、确认或关闭质量风险概览预警"))),
        ...
        contract("workflow-notification", "消息通知服务",
        ...
        contract("knowledge-package-export", "完整医疗资源包签发与医院导入服务",
            "com.medkernel.engine.knowledge.delivery.FullPackageExportController",
            "/api/v1/engine/knowledge/packages",
            permissions("platform.publish", "knowledge.export", "tenant.override"),
            audits(
                audit(AuditAction.PUBLISH, "mk_knowledge_package_registration", "签发并登记完整医疗资源包"),
                audit(AuditAction.IMPORT, "mk_knowledge_package_preflight", "记录完整医疗资源包固定根验签只读预检"),
                audit(AuditAction.IMPORT, "mk_knowledge_package_activation", "原子物化并激活完整医疗资源包"))),
        ...
        contract("pathway", "临床路径服务",
            ...
            audits(
                audit(AuditAction.CREATE, "pathway_template", "创建临床路径草稿和患者路径"),
                audit(AuditAction.PUBLISH, "pathway_template", "发布临床路径版本"),
        ...
        contract("terminology", "术语字典服务",
            ...
            audits(
                ...
                audit(AuditAction.CREATE, "term_mapping", "确认术语映射"),
                audit(AuditAction.REVIEW, "mapping_conflict", "处置术语映射冲突"))),
        contract("runtime-diagnostics", "运行诊断服务",
            "com.medkernel.engine.runtime.diagnostics.RuntimeDiagnosticsController",
            "/api/v1/system/runtime-diagnostics",
