...
public final class ServiceContractCatalog {
    private static final List<ServiceContract> CONTRACTS = List.of(
        ...
        contract("value-metrics", "价值指标与 ROI 服务",
            ...
            List.of()),
        contract("quality-dashboard", "质量管理概览服务",
            ...
            audits(
                audit(AuditAction.CREATE, "mk_quality_dashboard_alert", "生成质量管理概览预警视图"),
                audit(AuditAction.UPDATE, "mk_quality_dashboard_alert", "刷新、确认或关闭质量管理概览预警"))),
