...
public final class DomainEventSchemaCatalog {
    private static final List<DomainEventSchema> SCHEMAS = List.of(
        ...
        schema("clock-sla-breached-event.v1", 1,
            "com.medkernel.engine.event.ClockSlaBreachedEvent",
            "docs/contracts/events/clock-sla-breached-event.v1.json"),
        ...
        schema("override-captured-event.v1", 1,
            "com.medkernel.engine.event.OverrideCapturedEvent",
            "docs/contracts/events/override-captured-event.v1.json"),
        schema("pathway-variance-recorded-event.v1", 1,
            "com.medkernel.engine.event.PathwayVarianceRecordedEvent",
            "docs/contracts/events/pathway-variance-recorded-event.v1.json"),
        schema("rule-fired-event.v1", 1,
            "com.medkernel.engine.event.RuleFiredEvent",
            "docs/contracts/events/rule-fired-event.v1.json"),
