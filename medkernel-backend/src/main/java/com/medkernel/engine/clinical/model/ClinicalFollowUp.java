 ...
 * SYS-01 标准随访对象。
 */
@Table("mk_clinical_follow_up")
public record ClinicalFollowUp(
    @Id @Column("follow_up_id") @NotBlank String followUpId,
    ...
    @Column("plan_type") @NotBlank String planType,
    @Column("status") String status,
    @Column("planned_at") Instant plannedAt,
