 ...
 * SYS-01 标准诊断报告对象。
 */
@Table("mk_clinical_diagnostic_report")
public record ClinicalDiagnosticReport(
    @Id @Column("report_id") @NotBlank String reportId,
    ...
    @Column("report_type") @NotBlank String reportType,
    @Column("status") String status,
    @Column("conclusion") String conclusion,
