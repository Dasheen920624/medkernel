...
/**
 * API-02 客户面批量受理 suffix 路由。
 */
@RestController
@RequestMapping("/api/v1/engine/clinical-events:batch")
@DataScope(requireTenant = true)
public class ClinicalEventBatchSuffixController {

    private final ClinicalEventService service;

    public ClinicalEventBatchSuffixController(ClinicalEventService service) {
