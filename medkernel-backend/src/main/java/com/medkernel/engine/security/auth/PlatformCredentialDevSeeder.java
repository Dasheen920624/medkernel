...
public class PlatformCredentialDevSeeder implements ApplicationRunner {
    ...
    private static final Map<String, String[]> ACCOUNTS = Map.of(
        "system-superadmin", new String[]{"system-superadmin-1", "system-superadmin"},
        "platform-admin", new String[]{"platform-admin-1", "platform-admin"},
        "engine-operator", new String[]{"engine-operator-1", "engine-operator"},
        "clinical-user", new String[]{"clinical-user-1", "clinical-user"},
        "auditor", new String[]{"auditor-1", "auditor"}
    );
