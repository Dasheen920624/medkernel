...
public enum ErrorCode {
    ...
    ENG_CONTEXT_002("ENG-CONTEXT-002", 400, "机构生效版本不存在", ErrorClass.DATA, false),
    ...
    ENG_RULE_004("ENG-RULE-004", 409, "规则发布校验失败", ErrorClass.DATA, false),
    ...
    PATHWAY_CLOCK_MISSING("PATHWAY_CLOCK_MISSING", 409, "路径关键时钟缺少评价指标绑定", ErrorClass.DATA, false),
    ...
    ENG_REC_006("ENG-REC-006", 409, "高风险推荐缺少医师确认", ErrorClass.DATA, false),
    ...
    ENG_EVAL_005("ENG-EVAL-005", 404, "质量问题或整改任务不存在", ErrorClass.DATA, false),
    ENG_EVAL_006("ENG-EVAL-006", 400, "高风险质量问题缺少责任、期限或证据", ErrorClass.INPUT, false),
    ...
    ENG_EMBED_001("ENG-EMBED-001", 400, "启动凭证无效或已过期", ErrorClass.INPUT, false),
    ENG_EMBED_002("ENG-EMBED-002", 400, "非法的 Origin 域名", ErrorClass.INPUT, false),
    ENG_EMBED_003("ENG-EMBED-003", 409, "启动凭证已被使用", ErrorClass.DATA, false),
    ENG_EMBED_004("ENG-EMBED-004", 404, "启动凭证不存在", ErrorClass.DATA, false),
    ENG_EMBED_005("ENG-EMBED-005", 409, "启动凭证状态或嵌入契约不匹配", ErrorClass.DATA, false),
    ENG_LLM_001("ENG-LLM-001", 400, "能力尚未在该组织激活或不可用", ErrorClass.INPUT, false),
    ENG_LLM_002("ENG-LLM-002", 422, "模型输出不匹配期望字段结构", ErrorClass.DATA, false),
    ...
    ENG_LLM_006("ENG-LLM-006", 422, "模型外调允许范围缺失或超出允许范围，已阻断", ErrorClass.DATA, false),
    ...
    SORT_FIELD_NOT_ALLOWED("ENG-LIST-005", 400, "排序字段不在大规模列表允许范围内", ErrorClass.INPUT, false),
    PAGE_SIZE_EXCEEDED("ENG-LIST-006", 400, "请求页大小超过大规模列表上限", ErrorClass.INPUT, false),
    FILTER_FIELD_NOT_ALLOWED("ENG-LIST-007", 400, "过滤字段不在大规模列表允许范围内", ErrorClass.INPUT, false),
    ...
    KNOWLEDGE_PRODUCTION_PIPELINE_VIOLATION("ENG-KNOW-005", 422,
        "知识生产管道越界：客户禁产平台主源或反写平台主源", ErrorClass.INPUT, false),
    AGENT_CANDIDATE_SCHEMA_INVALID("ENG-KNOW-006", 400,
        "Agent 回写候选 schema、锚点、AI 标识或内容指纹不合格", ErrorClass.INPUT, false),
    AGENT_PATIENT_DATA_FORBIDDEN("ENG-KNOW-007", 403,
        "Agent 回写禁止携带患者数据或 D5 重要个人信息", ErrorClass.AUTH, false),
    ...
    ENG_AUTH_010("ENG-AUTH-010", 403, "高危操作需要先完成多因素认证", ErrorClass.AUTH, false),
