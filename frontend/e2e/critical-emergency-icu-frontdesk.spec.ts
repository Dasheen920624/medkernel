    ...
    body: JSON.stringify(
      {
        ...
        lisMonitoringCriticalConsumerSlice: {
          ...
          encounterId: textField(evidence.clinicalContext, "encounterId"),
          ...
          adapterId: textField(evidence.monitoringAdapter, "adapterId"),
          onboardingId: textField(evidence.emergencyOnboarding, "onboardingId"),
          webhookId: textField(evidence.webhookSignature, "webhookId"),
          inboundMessageId: textField(evidence.inboundMonitoringEvent, "messageId"),
          clinicalEventId: textField(
            recordField(evidence.inboundMonitoringEvent, "clinicalEvent"),
            "eventId",
          ),
        ...
        hisEmrCdrConsumerSlice: {
          ...
          contextSnapshotId: textField(evidence.clinicalContext, "contextSnapshotId"),
          runtimeReleaseId: textField(evidence.runtime, "releaseId"),
          cardId: textField(evidence.recommendation, "cardId"),
          feedbackId: textField(evidence.manualEscalation, "feedbackId"),
          todoId: textField(evidence.escalationTodo, "todoId"),
