    ...
    body: JSON.stringify(
      {
        ...
        regionalRemoteConsumerSlice: {
          ...
          aiGenerated: false,
          onboardingId: requireText(
            textField(evidence.fhirOnboarding, "onboardingId"),
            "区域远程消费者切片必须绑定接入申请",
          ),
          sourceId: requireText(
            textField(evidence.regionalSource, "sourceId"),
            "区域远程消费者切片必须绑定区域来源",
          ),
          fhirId: requireText(
            textField(evidence.inboundDiagnosticReport, "fhirId"),
            "区域远程消费者切片必须绑定 FHIR 报告",
          ),
          patientId: requireText(
          ...
          contextSnapshotId: requireText(
            textField(evidence.clinicalContext, "contextSnapshotId"),
            "区域远程消费者切片必须绑定上下文快照",
          ),
          ...
          todoId: requireText(
            textField(evidence.workflowTodo, "todoId"),
            "区域远程消费者切片必须绑定协同待办",
          ),
          compensationMessageId: requireText(
            textField(evidence.inboundDiagnosticReport, "compensationMessageId"),
            "区域远程消费者切片必须绑定补偿消息",
          ),
