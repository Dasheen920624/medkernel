...
- 当前本地工作：本轮已改 E2E 验收脚本和本接力文档；`.codex/config.toml` 为未跟踪本地配置，不提交。
...
- 当前目标：完成 MedKernel 全新项目上线级整体梳理与落地，统一平台权威版本与全链路能力，移除旧兼容和冗余设计，
  ...
  全功能与全知识全流程演练。
- 当前已完成事实：最新 `origin/main` 已在 134 清库部署，八段全系统、全知识、运行韧性、浏览器 E2E、覆盖审计与发布后
  独立验收已有通过证据；这证明本轮基线制品可运行，不等于全角色真实体验与全局产品优化已经闭环。
- 后续必须继续做的主线：进入真实前台全角色体验与全局产品优化，按医生、护士、药师、医技、质控、患者/代理、
  平台管理员、医疗引擎运营员、审计员、信息科长、实施工程师、院长等视角，扫描页面分类、流程完整性、权限态、错态、
  敏感信息处理和证据详情表达；不能只围绕用户临时提到的单点修补。
- 134 复演要求：产品修复和本地门禁完成后，仍需在 134 重新清库部署最新本地候选，并执行全角色、全功能、全知识、
  全流程复演；复演证据必须写回本文件。禁止把“已有基线证据”或“基础真实前台路线跑通”误报为当前目标全部完成。
