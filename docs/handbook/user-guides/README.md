...
> 状态：已由「全流程演练 · 使用指南 · 体验重构」激活；幕8.5 已补齐幕0-2前台复演配图和体验缺口登记；幕3已填充知识治理章，幕4已填充规则配置与模拟章，幕5已填充临床路径章，幕6已填充提醒与推荐章，幕7已填充智能随访与质控改进章，幕8已填充配置包与发布章，幕9已填充第三方对接案例集和适配器运维章，其余手册随幕10补齐
...
| 文件 | 受众 | 启用阶段 |
|---|---|---|
| [tenant-readiness.md](tenant-readiness.md) 试点准备用户手册 | 信息科主任 / 临床牵头人 / 知识包负责人 | 幕8.5已补齐幕1-2前台复演配图；幕2字典映射全状态机前台缺口已登记 |
