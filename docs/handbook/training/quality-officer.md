...
| 步骤 | 操作                                              | 证据                                                                                                                                                                                                                                              |
| ---- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | 在规则库查看危急值或 DDI 规则，并打开规则可读路径 | [规则列表](../../release/evidence/v1.0-drill-20260611/幕4-规则配置与模拟/ui-replay/01-rule-definitions-list.png)、[规则可读路径](../../release/evidence/v1.0-drill-20260611/P1-体验重构/规则可读路径-134复验/02-desktop-rule-readable-drawer.png) |
...
| 现象                                | 处理                                                                                                 |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------- |
| 规则详情出现技术字段影响客户讲解    | 优先打开“规则可读路径”，按自然语言摘要、命中条件、处置动作和医疗安全边界讲解；技术字段只用于专家排错 |
...
考核时只给本培训、[质控改进用户手册](../user-guides/quality-improvement.md)和[试点准备用户手册](../user-guides/tenant-readiness.md)。被训人员能独立复跑规则测试、用规则可读路径解释危急值或 DDI 规则、查看质控预警证据、解释灰度发布边界，即视为质控 / 医保角色通过。
