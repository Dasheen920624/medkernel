...
- [ ] FR-4 跳转来源：每条待办可跳来源页（提醒/患者/路径；仅安全站内 deepLink 显示为可点击来源，异常链接与缺失链接均诚实提示；页面展示来源对象与追踪链路）。
...
- [ ] AC-2（FR-3/4）：闭环处理留审计；跳转来源正确，异常 deepLink 不暴露为可点击外部 / 危险链接，缺失 deepLink 显示“来源未提供跳转”；来源对象与追踪链路来自真实 API 字段。
