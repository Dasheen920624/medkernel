...
| 规则 | `/api/v1/engine/rule/rules`、`/api/v1/engine/rule/rules/{ruleId}/test-cases`、`/api/v1/engine/rule/rules/{ruleId}/test`、`/api/v1/engine/rule/rules/{ruleId}/simulate`、`/api/v1/engine/rule/rules/{ruleId}/impact`、`/api/v1/engine/rule/rules/{ruleId}/publish`、`/api/v1/engine/rule/rules/evaluate`、`/api/v1/engine/rule/rules/executions/{executionId}/explain` |
