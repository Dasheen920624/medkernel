...
| 图谱 | 疾病、症状、检查、检验、药品、手术、耗材、指南条款、证据等级、路径节点 | 自动抽取实体、关系、证据链、冲突关系 | 专家纠错、关系权重、版本固化 | 图谱包 |
...
本计划以“按业务域纵向推进、从登录起、两波”为执行基线。旧的“引擎优先·自底向上（E0→E6）”节奏与旧并行计划仅作历史参考，不再作为当前计划。当前目标是沿真实用户旅程逐域做到“无模型也真实可用、可验证”：真实接口、真实状态、真实发布、真实审核、真实执行、真实降级和真实证据；模型/AI 整体后移第二波。
...
| 易用性 | 七业务域、7 步流、页内渐进详情方向正确 | 8/10 | 增加“医生零配置嵌入体验”和“信息科一小时接入路径” |
